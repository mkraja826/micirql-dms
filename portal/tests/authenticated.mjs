...
const patient = { id: PATIENT_ID, clinic_id: CLINIC_ID, patient_code: 'TEST-001', name: 'Demo Patient', phone: null, email: 'patient@example.invalid', age: 31, gender: 'Other', dob: '1995-01-01', address: 'Demo address', emergency_contact: '9000000003', created_by: USER_ID, created_at: monthDate, updated_at: monthDate, archived_at: null, archive_reason: null };
