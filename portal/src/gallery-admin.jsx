...
export default function GalleryAdmin({ profile, periodStart, periodEnd, periodLabel, onChanged }) {
  ...
  async function load() {
    ...
    } catch (err) { setError(err?.message || 'Unable to load the clinic gallery.'); }
    finally { setLoading(false); }
  }
  useEffect(() => { void load(); }, [profile.clinic_id, periodStart, periodEnd]);
