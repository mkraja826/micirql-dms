...
function Section({ section, data, clinic, profile, month, onRefresh }) {
  ...
  if (section === 'audit') return <><div className="admin-section-title"><h2>Audit and archived records</h2><p>Patient and appointment changes are now recorded with reasons and timestamps.</p></div><section className="admin-panel"><div className="admin-finance-note">Open a patient or appointment record to review field-by-field changes.</div></section></>;
